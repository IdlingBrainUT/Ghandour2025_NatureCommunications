...
Second_code: Extract the frequency for each neuron's activity in each session to determine their differential activity and neuronal specificity 
Third_code: calculate the cooccurence of neurons from different categories. 
