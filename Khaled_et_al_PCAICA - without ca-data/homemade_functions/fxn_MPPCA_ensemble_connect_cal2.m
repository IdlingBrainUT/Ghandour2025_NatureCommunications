function [Cells_AB_sum_t_index, Cells_AB_sum_index] = fxn_MPPCA_ensemble_connect_cal2(temp_ca_data1, temp_ca_data2, ensemble_set_A_IDs, ensemble_set_B_IDs, binarize_thr)
%% comment
% for ensemble shuffling
%%
temp_ca_A = temp_ca_data1(:, ensemble_set_A_IDs);
temp_ca_B = temp_ca_data2(:, ensemble_set_B_IDs);
