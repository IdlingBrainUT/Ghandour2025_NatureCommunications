...
function [result_connect] = fxn_MPPCA_ensemble_connectivity2(result_data_cell, result_MPPCA, session_num_assess, ensemble_set_A, ensemble_set_B, shuffle_mode, binarize_thr, thr_percentile)
%% comment
% 211118: 1st ver
%% debug info
